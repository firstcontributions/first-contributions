...
# पहिलो योगदान
कुनै पनि प्रोजेक्टमा पहिलोचोटी योग्दान ( contribute ) गर्न कठिन हुनसक्छ । पहिलोपल्ट केहि गर्दा सधै कठिन हुन्छ, बिशेषगरि जब तपाई कसै अरुको प्रोजेक्ट ( github repository )मा योगदान गर्दै हुनुहुन्छ, आफुबाट गल्ती हुन्छ कि, भनेर डराउनु स्व्भाविक हो । 
हामी 'नया खुला स्रोत योगदानकर्ता' ( new open source contributer )लाई पहिलोचोटी योग्दान गर्ने मौका दिन चाहन्छौ । 

 लेखहरु पढेर वा ट्यूटोरियलहरू हेरेर भन्दा, आफै ( अभ्यास ) गरेर नै सिक्न सजिलो हुन्छ भन्ने धारणा राखी हामीले यो प्रोजेक्ट ( github repository ) बनाएका हौ । यो प्रोजेक्टले कसरी कुनै प्रोजेक्ट ( github repository ) मा योग्दान ( contribute ) गर्न सकिन्छ भनेर सिकाउछ । तपाईंको पहिलो योग्दान को लागि तल लेखिएको निर्देशनहरु पालना गर्नुहोला :
...
```
अब `git checkout` आदेश प्रयोग गरेर एउटा हाँगा सिर्जना गर्नुहोस्:
```
git checkout -b <हाँगाको-नाम>
```
उदाहरणका लागि:
```
git checkout -b add-milap-neupane
```
(हाँगा को नाममा *add* शब्द को आवश्यकता छैन, तर यसमा एक उचित कुरा समावेश छ किनभने यस हाँगाको उद्देश्य तपाईंको नामलाई सूचीमा थप्न हो।)
...
तपाईँले भर्खरै बनाएको हाँगामा `git add` कमांड प्रयोग गरी ती परिवर्तनहरू थप्नुहोस्:
...
```
git push origin <हाँगाको-नाम>
```
तपाईले पहिले सिर्जना गर्नुभएको हाँगाको नामको साथ `<हाँगाको-नाम>` को प्रतिस्थापन गर्नुहोस्।
...
चाँडै म यस परियोजनाको मास्टर हाँगामा तपाईका सबै परिवर्तनहरू मर्ज गर्नेछु। परिवर्तनहरू विलय भएपछि एक अधिसूचना इमेल प्राप्त गर्नुहुनेछ।
