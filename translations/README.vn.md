...
_Người dịch: [Tran Ly Vu](https://github.com/tranlyvu)_
_Người chỉnh sửa: [Phuc Cai](https://github.com/hoangphuc05)_
...
#### _Nếu bạn không thích làm việc với dòng lệnh, [đây là hướng dẫn sử dụng GUI.](#Hướng-dẫn-sử-dụng-các-công-cụ-khác)_
...
Bây giờ sao chép kho mã nguồn này vào máy của bạn. Nhấn vào nút `clone` và sau đó nhấn vào biểu tượng _copy to clipboard_
...
(Tên của chi nhánh không cần phải có từ _thêm_ trong đó, nhưng nó được dùng vì mục đích của chi nhánh này là thêm tên của bạn vào danh sách.)
