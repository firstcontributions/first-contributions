...
नई शाखा बनाने के लिए -b विकल्प का उपयोग होता है ।  
...
## अपने बदलावों को Github में धकेलें (पुश करें) ।

`git push` का उपयोग कर अपने परिवर्तन को धकेलें  ।
...
यदि आप अपने Github प्रोफाइल पर अपनी रिपॉज़िटरी में जायेंगे तो आपको Compare & pull request का विकल्प दिखेगा। उसे दबाएं ।
...
बधाई! आपने मानक _fork -> clone -> edit -> PR_ वर्कफ्लो की पूर्ति कर ली है, जिसका आप अक्सर एक योगदानकर्ता के रूप में सामना करेंगे! 
