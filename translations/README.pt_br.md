...
#### *Se você não se sente confortável com linha de comando, [aqui estão alguns tutoriais de ferramentas gráficas.](https://github.com/MatheusRV/first-contributions/blob/master/translations/README.pt_br.md#tutoriais-usando-outras-ferramentas)*
