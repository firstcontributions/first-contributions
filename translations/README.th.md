...
โปรเจ็คหลักนี้ จะเรียกว่า โปรเจ็คต้นฉบับ คุณสามารถแยกโปรเจ็คต้นฉบับออกไปทำที่แอคเคาน์ส่วนตัวของคุณได้ โดยการกดปุ่ม "Fork" ที่ด้านบนของหน้านี้

แล้วโปรเจ็คต้นฉบับจะถูกคัดลอกฉบับไปใส่ไว้ในแอคเคาน์ของคุณ
