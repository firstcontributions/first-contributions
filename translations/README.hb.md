...
כעת פתחו את הקובץ, `Contributors.md` בתוכנת עריכת טקסט והוסיפו את שמכם אליו. אל תוסיפו את השם בתחילת הקובץ או בסופו. הוסיפו אותו באמצע. לאחר שסיימתם, שמרו את הקובץ.


 נווטו לתיקיית הפרויקט והריצו `git status`, תוכלו לראות את השינויים שביצעתם.
הוסיפו את השינויים לענף שיצרתם תוך שימוש בפקודה `git add`:
</div>
...
החליפו את הביטוי `<your-name>` עם שימכם
</div>
...
החליפו את `<add-your-branch-name>` עם שם הענף שיצרתם מוקדם יותר
</div>

<div dir="rtl">
<h2> הגישו את השינויים לסקירה </h2>
</div>

<div dir="rtl">
  
בדקו את המאגר שלכם ב-GitHub, לחצו על כפתור עם הכיתוב `Compare & pull request`.
