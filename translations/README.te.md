...
#### *మీకు కమాండ్ లైన్ సౌకర్యంగా లేకపోతే, [ఇక్కడ GUI సాధనాలను ఉపయోగించి ట్యుటోరియల్స్ ఉన్నాయి.]( #tutorials-using-other-tools )*
...
మీకు మీ కంప్యూటరులో GIT లేకపోతే, [GIT ఇంస్టాల్ చేసుకోవటానికి పక్కనే ఉన్న లింకు ప్రెస్ చేయండి]( https://help.github.com/articles/set-up-git/).

## ఒక రిపోజిటరీని ఫోర్క్ చేయడం  

ఈ రిపోజిటరీని ఫోర్క్ చేయడానికి ఈ పేజీ ఎగువ భాగంలో ఫోర్క్ బటన్ పై క్క్లిక్ చేయండి.
దీని ద్వారా మీ ఖాతాలో ఈ రిపోజిటరీ కాపీని సృష్టించవచ్చు.

## రిపోజిటరీని క్లోన్ చేయడం 

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/clone.png" alt="clone this repository" />

ఇప్పుడు మీ కంప్యూటరులో ఫోర్క్ చేసిన రిపోను క్లోన్ చేయండి. మీ GitHub ఖాతాకు వెళ్లండి, ఫోర్క్ రెపోని తెరిచి, క్లోన్ బటన్పై క్లిక్ చేసి, ఆపై * కాపీ * క్లిప్బోర్డ్కు క్లిక్ చేయండి.

టెర్మినల్ తెరిచి కింది git ఆదేశాన్ని అమలు చేయండి:
```
git clone "మీరు కాపీ చేసిన URL"
```
ఇక్కడ "మీరు కాపీ చేసిన URL" (కోట్ మార్కులు లేకుండా) ఈ రిపోజిటరీ కు URL (ఈ ప్రాజెక్టు మీ ఫోర్క్). Url ను పొందడానికి మునుపటి దశలను చూడండి.
...
```
ఇక్కడ 'this-is-you' మీ GitHub వినియోగదారు పేరు. ఇక్కడ మీరు మొదటి-చూసిన రిపోజిటరీ యొక్క కంటెంట్లను GitHub లో మీ కంప్యూటర్కు కాపీ చేస్తున్నారు.

## ఒక శాఖను సృష్టించండి

మీ కంప్యూటర్లో మేరు ఉన్న డైరెక్టరీని మీరు కలోనే చేసిన డైరెక్టరీకి మార్చండి (మీరు ఇప్పటికే లేకపోతే):
...
టెక్స్ట్ ఎడిటర్లో ఇప్పుడు `Contributors.md` అనే ఫైల్ ఓపెన్ చేయండి, దానికి మీ పేరుని జోడించండి. ఫైల్ ప్రారంభంలో లేదా ముగింపులో జోడించవద్దు. మధ్యలో ఎక్కడైనా ఉంచండి. ఇప్పుడు, ఫైల్ను సేవ్ చేయండి.
...
మీరు ఈ మీ contribution ని సంబరంగా జరుపుకోండి మీ స్నేహితులతో మరియు ఫోలలోవర్ తో  పంచుకోవటానికి ఈ వెబ్ అప్ప ను సందర్శించండి [web app](https://roshanjossey.github.io/first-contributions/#social-share) కు వెళ్లండి.
