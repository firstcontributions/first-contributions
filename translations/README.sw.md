...
_Ikiwa hauko vizuri na mstari wa amri, [hapa kuna mafunzo kwa kutumia zana za GUI.](#tutorials-using-other-tools)_

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/fork.png" alt="weka hazina hii" />

#### Ikiwa huna git kwenye mashine yako, [isakinishe](https://help.github.com/articles/set-up-git/).

## Weka hazina hii
Weka hazina hii kwa kubofya kitufe cha uma kilicho juu ya ukurasa huu.
...
Sasa unganisha hazina iliyogawanyika kwa mashine yako. Nenda kwa akaunti yako ya GitHub, fungua hazina iliyonakiliwa, bonyeza kitufe cha kodi kisha ubofye alama ya _copy to clipboard_.

Fungua terminal na uingize amri ya git ifuatayo:
```
git clone "url you just copied"
```

ambapo "url you just copied" (bila alama za nukuu) ndio url ya hazina hii (uma wako wa mradi huu). Tazama hatua za awali ili kupata url.
...
Badilisha kwa uende kwenye faili ya hazina kwenye kompyuta yako (ikiwa haupo tayari):

```
cd first-contributions
```

Sasa tengeneza tawi kwa kutumia amri `git checkout`:
...
(Jina la tawi halihitaji kuwa na neno _add_ ndani yake, lakini ni jambo la busara kujumuisha kwa sababu madhumuni ya tawi hili ni kuongeza jina lako kwenye orodha.)

## Fanya mabadiliko muhimu na usainishe mabadiliko hayo

Sasa fungua faili ya `Contributors.md` katika kihariri maandishi, ongeza jina lako kwayo. Usiiongeze mwanzoni au mwisho wa faili. Weka popote kati. Sasa, hifadhi faili.

<img align="right" width="450" src="https://firstcontributions.github.io/assets/Readme/git-status.png" alt="git status" />

Ukienda kwenye faili ya mradi na kutekeleza amri `git status`, utaona kuna mabadiliko.
...
ukibadilisha `<jina-lako>` kwa jina lako.

## Sukum mabadiliko kwenda GitHub
...
Ukibadilisha `<add-your-branch-name>` na jina la tawi ulilounda awali.

## Wasilisha mabadiliko yako kwa ukaguzi

Ukienda kwenye hazina yako kwenye GitHub, utaona kitufe `Compare & pull request`. Bofya kitufe hicho.

<img style="float: right;" src="https://firstcontributions.github.io/assets/Readme/compare-and-pull.png" alt="unda ombi la kuvuta" />

Sasa tuma ombi la kuvuta.

<img style="float: right;" src="https://firstcontributions.github.io/assets/Readme/submit-pull-request.png" alt="tuma ombi la kuvuta." />

Hivi karibuni nitakuwa nikiunganisha mabadiliko yako yote kwenye tawi kuu la mradi huu. Utapata arifa ya barua pepe mara tu mabadiliko yameunganishwa.

## Uende wapi kutoka hapa?

Hongera! Umekamilisha kiwango cha _fork -> clone -> edit -> pull request_ mtiririko wa kazi ambao utakutana nao mara nyingi kama mchangiaji!
...
Unaweza kujiunga na timu yetu ya wanyonge ikiwa utahitaji usaidizi wowote au una maswali yoyote. [Join slack team](https://join.slack.com/t/firstcontributors/shared_invite/zt-vchl8cde-S0KstI_jyCcGEEj7rSTQiA).

Sasa hebu tuanze na kuchangia miradi mingine. Tumekusanya orodha ya miradi yenye masuala rahisi ambayo unaweza kuanza nayo. Angalia [orodha ya miradi katika programu ya wavuti](https://firstcontributions.github.io/#project-list).
