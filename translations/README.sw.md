...
####_Isome hii katika [Lugha nyingine](translations/Translations.md)._
...
<kbd>[<img title="Swahili (Tanzania)" alt="Swahili (Tanzania)" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/tz.svg" width="22">](translations/README.sw.md)</kbd>
...
Mradi huu unalenga kurahisisha na kuongoza jinsi wanaoanza kutoa mchango wao wa kwanza. Ikiwa unatazamia kutoa mchango wako wa kwanza, fuata hatua zilizo hapa chini.

_Ikiwa hauko vizuri na mstari wa amri(CLI), [hapa kuna mafunzo kwa kutumia zana za Kiolesura cha Mtumiaji wa Picha(GUI)](#tutorials-using-other-tools)_

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/fork.png" alt="fork this repository" />

#### Ikiwa huna git kwenye mashine yako, [isanikishe hapa](https://docs.github.com/en/get-started/quickstart/set-up-git).

## Tengeneza kopi ya hii hazina

Gawanya nakala hii ya hazina kwa kubofya kitufe cha gawanya juu ya ukurasa huu. Hii itaunda nakala ya hazina hii kwenye akaunti yako.

## Nakili nakala ya hazina.

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/clone.png" alt="clone this repository" />

Sasa nakili nakala ya hazina uliyogawanya(forked) kwenye kompyuta yako. Nenda kwenye akaunti yako ya GitHub, fungua nakala ya hazina uliyogawanya, bonyeza kitufe cha 'code,' kisha bonyeza ishara ya 'nakili kwenye ubao.'(_copy_)

Fungua kidirisha cha amri(Terminal) na tekeleza amri ya git ifuatayo:

```
git clone "Anwani (URL) uliyonakili tu."
```

ambapo 'anwani (URL) uliyonakili tu' (bila alama za nukuu) ni anwani ya nakala hii ya hazina (yako uliyogawanya kutoka kwenye mradi huu). Tazama hatua za awali kupata anwani.
...
ambapo 'hii-ni-wewe' ni jina lako la mtumiaji wa GitHub. Hapa unanakili maudhui ya nakala ya hazina ya first-contributions kwenye GitHub kwenye kompyuta yako.

## Tengeneza tawi

Ingia kwenye saraka ya hazina kwenye kompyuta yako (ikiwa bado hujafanya hivyo):
...
```
git switch -c tawi-la-kwanza
```

## Fanya mabadiliko muhimu na thibitisha mabadiliko hayo.

Sasa fungua faili ya 'Contributors.md' kwa kutumia mhariri wa maandishi, weka jina lako kwenye faili hiyo. Usiweke mwanzoni wala mwishoni mwa faili. Weka popote katikati. Kisha, uhifadhi faili.

<img align="right" width="450" src="https://firstcontributions.github.io/assets/Readme/git-status.png" alt="git status" />

Ukienda kwenye saraka ya mradi na kutumia amri 'git status,' utaona kuna mabadiliko.

Wekeza mabadiliko hayo kwenye tawi ulilounda kwa kutumia amri ya 'git add':

```
git add Contributors.md
```

Sasa thibitisha mabadiliko hayo kwa kutumia amri ya 'git commit':

```
git commit -m "Weka 'jina-lako' kwenye orodha ya Wahisani.""
```

Badilisha 'jina-lako' kwa kuweka jina lako.

## Sukuma(Peleka) mabadiliko kwenye GitHub.

Sukuma(Peleka) mabadiliko yako kwa kutumia amri ya 'git push':

```
git push -u origin jina-la-tawi-lako-jipya
```

Badilisha 'jina-la-tawi-lako-jipya' na jina la tawi ulilounda awali.
...
## Wasilisha mabadiliko yako kwa ajili ya uchunguzi.

Ikiwa utaenda kwenye hazina yako kwenye GitHub, utaona kitufe cha `Tofautisha na omba fikio.(Compare & pull request)` Bonyeza kitufe hicho.

<img style="float: right;" src="https://firstcontributions.github.io/assets/Readme/compare-and-pull.png" alt="create a pull request" />

Sasa wasilisha ombi la fikio (pull request).

<img style="float: right;" src="https://firstcontributions.github.io/assets/Readme/submit-pull-request.png" alt="submit pull request" />

Hivi karibuni nitakuwa nakiunganisha mabadiliko yako yote kwenye tawi kuu la mradi huu. Utapokea barua pepe ya taarifa mara tu mabadiliko yameunganishwa.

## Ninakwenda wapi kutoka hapa?

Hongera! Umekamilisha mchakato wa kawaida wa `gawanya(fork) -> nakala(clone) -> hariri(edit) -> omba(pull)` fikio ambao mara nyingi utakutana nao kama mchango!

Sherehekea mchango wako na uushirikishe na marafiki na wafuatiliaji wako kwa kwenda kwa [programu ya wavuti](https://firstcontributions.github.io/#social-share).

Unaweza kujiunga na timu yetu ya Slack ikiwa unahitaji msaada au una maswali yoyote.[Jiunge na timu ya Slack](https://join.slack.com/t/firstcontributors/shared_invite/zt-1hg51qkgm-Xc7HxhsiPYNN3ofX2_I8FA).

Sasa hebu tukuwezeshe kuanza kuchangia kwenye miradi mingine. Tumekusanya orodha ya miradi yenye matatizo madogo unayoweza kuanza nayo. Tazama [orodha ya miradi katika programu ya wavuti](https://firstcontributions.github.io/#project-list).

### [Vifaa vingine](additional-material/git_workflow_scenarios/additional-material.md)

## Vifundisho Kutumia Zana Nyingine
