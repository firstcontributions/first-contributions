...
## Cabangkan repositori ini

Cabangkan repositori ini dengan cara menekan tombol *fork* yang ada di bagian kanan atas layar,
...
Sekarang klon repositori ini ke komputer Anda lalu tekan tombol clone kemudian tekan ikon "copy to clipboard".
...
## Masukkan perubahan untuk diulas
...
Cabang master dari percabangan Anda tidak akan memiliki perubahan-perubahan tersebut. Untuk membuat percabangan Anda selaras dengan milik Saya, ikuti langkah-langkah berikut.
