...
Membaca artikel dan menonton tutorial dapat membantu, tetapi apa yang lebih baik daripada langsung mempraktikan hal-hal tersebut? Mencoba langsung! Maka dari itu proyek ini bertujuan untuk memberikan panduan dan mencoba menyederhanakan cara memberikan kontribusi pertama bagi pemula. Jika Anda ingin memberikan kontribusi untuk pertama kalinya, ikuti langkah-langkah di bawah ini.

#### _Jika Anda tidak nyaman menggunakan baris perintah (CLI), [silahkan pelajari tutorial menggunakan GUI di sini.](#Tutorial-Menggunakan-Alat-Lain)_
...
Selamat! Anda baru saja menyelesaikan *fork* -> *clone* -> ubah -> *Pull Request*, di mana ini merupakan alur kerja yang akan sering Anda temui sebagai kontributor!
