...
<img style="float: right;" src="../assets/compare-and-pull.png" alt="créer une demande de tirage" />

Maintenant soumettez la demande de tirage.

<img style="float: right;" src="../assets/submit-pull-request.png" alt="soumettre la demande de tirage" />
