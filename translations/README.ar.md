...
<div dir="rtl">
الصعوبة متوقعة عندما تبدأ بأي عمل جديد، خصوصاً إذا كان العمل يتضمن أشخاصا آخرين، مما يجعل الوقوع في الخطأ مزعجا.
<br>
لكن المساهمة في مشاريع مفتوحة المصدر يتطلب ويتوقع الخطأ ولهذا السبب الآخرين سيساعدونك في تصحيح هذا الخطأ.
<br>
