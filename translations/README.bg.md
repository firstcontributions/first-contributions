...
```
Като на мястото на `this-is-you` се намира вашето потребителско име. В тази стъпка вие направихте копие на съдържанието на GitHub хранилището на 'first contributions' във вашия компютър.
...
Поздравления!  Вие току що изпълнихте стандартните _fork -> clone -> edit -> PR_ операции, които ще срещнете като сътрудник!
...
Време да започнете да допринасяте и към други проекти. Ние сме съставили списък с проекти съдържащи лесни проблеми, които са лесни за начало. Проверете  [списъка от проекти в уеб приложението](https://roshanjossey.github.io/first-contributions/#project-list).

### [Допълнителни материали](../additional-material/git_workflow_scenarios/additional-material.md)


## Уроци за използването на други приложения
