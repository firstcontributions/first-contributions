...
Si no tienes git en tu equipo, puedes encontrar instrucciones para instalarlo en [este enlace][link-Github_git].
...
[link-Github_git]: https://docs.github.com/es/get-started/quickstart/set-up-git