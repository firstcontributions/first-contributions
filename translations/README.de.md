...
```
An der Stelle von `dein-Name` muss dein GitHub-Username stehen. Mit diesem Befehl kopierst du den Inhalt deines first-contributions-Repository von GitHub auf deinen Computer.
...
```
Ersetze `<dein-Name>` mit deinem Namen oder Benutzernamen.
...
Roshan Jossey wird nun bald deine Änderungen in den Master Branch dieses Projekts mergen. Du erhältst eine E-Mail, sobald dies geschehen ist. 
