...
Եթե դուք չեք համապատասխանում հրամանի տողին, [այստեղ կան tutorials օգտագործելով GUI (գրաֆիկական օգտագործողի ինտերֆեյս) գործիքները](#tutorials-using-other-tools)_

Եթե ձեր մեքենայի վրա git չկա, տեղադրեք այն:
