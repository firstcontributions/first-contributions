...
Енді бұл өзгерістерді `git commit` командасымен коммиттаңыз.
...
Егер сізге көбірек тәжірибе керек болса, [code contributions](https://github.com/roshanjossey/code-contributions) репозиторийін тексеріңіз.
