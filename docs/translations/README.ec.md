...
- ### Error de Autenticación
  ...
  fatal: Fallo en la autenticación para '(https://github.com/)<tu-usuario>/first-contributions.git/'</pre>
    Ve al (https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) sobre cómo generar y configurar una clave SSH en tu cuenta.
