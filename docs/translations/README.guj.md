...
પ્રથમ વખત કંઈક કરવું થોડું મુશ્કેલ છે. ખાસ કરીને જ્યારે તમે જુથ સાથે મળીને કામ કરી રહ્યા હોવ, ત્યારે ભૂલો કરવી એ સારી વાત નથી. પરંતુ એકબીજા સાથે મળીને એક જ લક્ષ્ય માટે કામ કરવું — એ જ તો ઓપન સોર્સ છે. અમે તમારું પ્રથમ ઓપન સોર્સ કોન્ટ્રિબ્યુશન / યોગદાન સરળ બનાવવાનો પ્રયત્ન કરીશું.
...
જો તમે કમાન્ડ લાઇન સાથે પરિચિત ન હોવ, તો અહીં [ GUI ટૂલ્સનો ઉપયોગ કરવાના ટ્યુટોરિયલ્સ ](https://github.com/firstcontributions/first-contributions#tutorials-using-other-tools) આપેલ છે.

<img align="right" width="300" src="https://firstcontributions.github.io/assets/Readme/fork.png" alt="આ રિપોઝિટરીને ફોર્ક કરો" />
...
ચાલો, હવે અમે તમને અન્ય પ્રોજેક્ટ્સમાં કોન્ટ્રિબ્યુટ કરવામાં મદદ કરીએ. અમે તમારા માટે એક યાદી બનાવી છે જેમા ખૂબ સરળ issues(મુદ્દાઓ) છે. [વેબ એપમા પ્રોજેક્ટ્સ ની સૂચિ જુઓ.](https://firstcontributions.github.io/#project-list)
