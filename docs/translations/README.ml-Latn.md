...
# Aadya Sambhavanakal (First Contributions)

Aadyamay oru kaaryam cheyyuka ennulathu valare buddhimuttanu. Prathyekichu, mattu palarudeyum oppam joli cheyyumbol thettu varunnathu athra sukhakaramaya kaaryam alla. Swathanthra software-lekku aadyamay sambhavanam cheyyunnavarkku athine patti padikkanum pankali aakuvaanum vendi kurachu koodi eluppamaya enthenkilum undaakkanam ennayirunnu njangalude aagraham.

Lekhanangal vayikkunnathum video kaanunnathum okke sahayakaramaanu. Paksha cheythu thanne padikkunnathaanu ettavum nallathu.

Ee project ithine patti parichayam illatha oralkku aadyathe sambhavanam nalkanulla oru vazhikaatti aanu.

Ningalum ningalude aadyam sambhavanam nalkan aagrahikkunnu engil thaazhe parayunnathu pole cheyyuka.
...
Pinne oru terminal thurannu thaazhe parayunna git command run cheyyuka:

```bash
git clone <ningalude-link>
```
...
Maattangal branch-ilekku add cheyyan:

```bash
git add Contributors.md
```

Pinne commit cheyyan:

```bash
git commit -m "Add <ningalude-peru> to Contributors list"
```

Ivde `<ningalude-peru>` ennathinu pakaram ningalude peru kodukkuka.
