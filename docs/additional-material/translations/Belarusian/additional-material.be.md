...
### [Выпраўленні ў каміты](amending-a-commit.be.md)
...
### [Канфігураванне GIT](configuring-git.be.md)
...
### [Сінхранізацыя вашага адгалінаванні з асноўным рэпазітаром](keeping-your-fork-synced-with-this-repository.be.md)
...
### [Перамяшчэнне камітаў ў іншую галінку](moving-a-commit-to-a-different-branch.be.md)
...
### [Выдаленне файла](removing-a-file.be.md)
...
### [Выдаленне галінкі з вашага рэпазітара](removing-branch-from-your-repository.be.md)
...
### [Дазвол канфліктаў пры зліцці галінак](resolving-merge-conflicts.be.md)
...
### [Адмена камітаў](reverting-a-commit.be.md)
...
### [Сумяшчэнне камітаў (squashing)](squashing-commits.be.md)
...
### [Адмена лакальнага каміту](undoing-a-commit.be.md)
...
### [Карысныя спасылкі](Useful-links-for-further-learning.be.md)
