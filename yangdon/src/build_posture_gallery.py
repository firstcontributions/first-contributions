...
이미지/영상은 축소·압축해 data URI 로 임베드(자체완결 HTML).
    ...
    python yangdon/src/build_posture_gallery.py [대회경로]
"""
...
TEMPLATE = os.path.join(ROOT, "yangdon", "dashboard", "posture_gallery_template.html")
OUT_HTML = os.path.join(ROOT, "yangdon", "dashboard", "posture_gallery.html")
