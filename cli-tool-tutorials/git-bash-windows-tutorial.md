...
Go to the directory where the repo exists and open it up on vs code to make your changes. You can use the command "code ." to open the entire folder in vs code directly from the command line.
