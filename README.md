...
### 1. Git: Username/Email not set
If your commits show “unknown author”, set username & email:
...
If GitHub keeps asking for username/password:
...
Fix:
- Make sure you cloned **your own fork**, not the original repo  
- Or use HTTPS:
```
