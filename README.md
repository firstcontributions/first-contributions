...
- ### Authentication Error
  ...
  <br>You can also access your account by using access token. Go to [Github's tutorial](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/creating-a-personal-access-token) to generate personal access token instead of password.
  You can also checkout [LinkedIn post](https://www.linkedin.com/pulse/how-fix-githubs-support-password-authentication-removed-chapuma/) for the same.</br>
