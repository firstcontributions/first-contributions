...
Now clone the forked repository to your machine. Go to your GitHub account, open the forked repository, click the Code button, select the SSH tab, and copy the URL to your clipboard.
