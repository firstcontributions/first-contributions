...
#### If you don't have Git installed on your machine, [install it](https://docs.github.com/en/get-started/quickstart/set-up-git) before continuing with the steps below.
