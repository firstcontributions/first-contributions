...
Now clone the forked repository to your machine. Go to your GitHub account (www.github.com), open the forked repository, click on the code button and then click the _copy to clipboard_ icon.
