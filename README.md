...
Now open `Contributors.md` file in a text editor, add your name and GitHub profile link `- [your-name](https://github.com/your-user-name)` to it. Don't add it at the beginning or end of the file. Put it anywhere in between. Now, save the file.
