...
It's always hard when you do something for the first time, especially when you are collaborating. Making mistakes isn't a comfortable thing. We want to simplify the way new open-source contributors learn & contribute for the first time.

Reading articles & watching tutorials can help, but doing the same thing in practice is always a better thing in any field you can think of. This project aims at providing guidance & simplifying the way beginners make their first contribution. If you are looking to make your first contribution.
