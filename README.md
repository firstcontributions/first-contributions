...
To intilize git : use git init                                                          |
If you want to see your commit on git, You can Use git log
If you want to add your changes in repo to Staging Area : You can use git add 
