...
where "url you just copied" (without the quotation marks) is the url to this repository (i.e the fork you've made to this project). See the subsequent steps to obtain the url.
