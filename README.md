# First-contributions
<p align="center"><img width=400px height=300px src="https://blog.hyperiondev.com/wp-content/uploads/2018/11/Blog-GitHub.jpg" alt="Project logo"></a>
...
First Contributions is a project which aims to simplify and guide the way beginners make their first contribution. If you are looking to make your first contribution, follow the steps below.

If you are a beginner and not comfortable with the command line, [here are some tutorials using the GUI tools.](#tutorials-using-other-tools)
...
![image](https://firstcontributions.github.io/assets/Readme/fork.png)<br/>
...
![image](https://firstcontributions.github.io/assets/Readme/clone.png)<br/>
...
![image](https://firstcontributions.github.io/assets/Readme/copy-to-clipboard.png)<br/>
...
## Make necessary changes , commit those changes and add the necessary details

 
Woohoo! You're almost there! Open the **contributors-list.md** file in a text editor and add your name and a little about yourself , Don't add it at the beginning or end of the file. Put it anywhere in between. Now, save the file.



If you go to the project directory and execute the command **git status**, you'll see there are changes.

![image](https://firstcontributions.github.io/assets/Readme/git-status.png)<br/>
...
Now submit the pull request, after ensuring that the base repository is **firstcontributions/first-contributions** and head repository is  **<your-username>/first-contributions** <br/><br />
...
## Tutorials Using Some Other Tools
