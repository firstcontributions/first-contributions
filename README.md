...
If you go to your repository on GitHub, you'll see a  `Compare & pull request` button in the top right of the page by your profile icon/image. Click on that button.

<img style="float: right;" src="assets/compare-and-pull-new.png" alt="create a pull request" />
