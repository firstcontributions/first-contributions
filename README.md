...
If you go to your repository on GitHub, you'll see a `Compare & pull request` button. Maybe you will need to wait few seconds until it shows up. Click on that button.
