...
## 🧑‍💻 Prefer GUI instead of Terminal?

If you're not comfortable using the command line, you can still contribute using graphical tools.

👉 Check out these beginner-friendly GUI tutorials below 👇
