...
If you go to our repository (the original repository from which you forked in the first place) on GitHub, you'll see a  `Compare & pull request` button.  Click on that button.
