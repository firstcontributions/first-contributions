...
- ### Authentication Error
  ...
  fatal: Authentication
   failed for 'https://github.com/<your-username>/first-contributions.git/'</pre>
...
After cloning the repository in GitHub Desktop, you’ll see two options:

- **Contribute to the parent project** → choose this if you want your changes to go back to the original tutorial.
- **Use for my own purposes** → choose this if you just want your own copy.
