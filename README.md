...
Fork this repository by clicking on the fork button located on the top of this page.
...
Replace "url you just copied" (without the quotation marks) with the url to your forked repository. See the previous steps to obtain the url.
...
Replace `this-is-you` with your GitHub username. Here you're copying the contents of the first-contributions repository on GitHub to your computer.
...
Replace `your-name` with your name; feel free to add a link to your GitHub profile.
