...
- ### Authentication Error
  ...
  <pre>Also you might want to run 'git remote -v' to check your remote address.
  If it looks anything like this:
  
  'origin	https://github.com/your-username/your_repo.git (fetch)'
  'origin	https://github.com/your-username/your_repo.git (push)'
  
  change it using this command:</pre>
  ```bash
  git remote set-url origin git@github.com:your-username/your_repo.git
  ```
  <pre>Otherwise you'll still get prompted for username and password and get authentication error.</pre>
</details>
