...
Now open `Contributors.md` file in a text editor, add your name to it. Don't add it at the beginning or at the end of the file. Put it anywhere in between. Now, save the file.
