[![Open Source Love](https://firstcontributions.github.io/open-source-badges/badges/open-source-v1/open-source.svg)](https://github.com/firstcontributions/open-source-badges)
    ...
    If Github prompts you to login, click ``Sign in with you browser``. Then, in your browser, click ``Authorize GitCredentialManager``. Once you get redirected to a blank page, you may close that tab.
