...
<table>
  <tr>
    ...
    <td>
    	<a href="gui-tool-tutorials/github-windows-vs2017-tutorial.md"><img alt="Visual Studio 2017" src="https://upload.wikimedia.org/wikipedia/commons/c/cd/Visual_Studio_2017_Logo.svg" width="100"></a>
    </td>
    <td>
    ...
    <td>
      <a href="gui-tool-tutorials/github-cli-tutorial.md">
        <svg width="100" height="200" viewBox="0 0 16 16" aria-hidden="true">
