...
If you go to your repository on GitHub, you'll see a  `Compare & pull request` button in the top right. Click on that button.

<img style="float: right;" src="assets/new-compare-and-pull.png" alt="create a pull request" />
