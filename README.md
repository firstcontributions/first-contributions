...
- **Forgetting to fork the repository**
  - Always fork the repo before making changes. Direct pushes to the original repository are usually not allowed.

- **Working on the `main` branch**
  - Create a new branch for each contribution to keep changes clean and reviewable.

- **Not updating your fork**
  - Sync your fork with the upstream repository before starting new work to avoid conflicts.

- **Merge conflicts**
  - Conflicts occur when changes overlap. Pull the latest updates and resolve conflicts carefully before pushing.

- **Unclear commit messages**
  - Use meaningful commit messages that explain what the change does (e.g., `docs: update README`).

- **Large or unrelated changes**
  - Keep pull requests small and focused on a single task for easier reviews.

- **Ignoring contribution guidelines**
  - Always check `CONTRIBUTING.md` or the README before contributing.

- **Not checking changes before submitting**
  - Preview your changes locally to ensure everything looks correct.
