...
•⁠  ⁠*Forgot to fork the repository*: Make sure you fork the project before making any changes.
•⁠  ⁠*Changes made on the main branch*: Always create a new branch before editing files.
•⁠  ⁠*Merge conflicts*: Pull the latest changes from the upstream repository and resolve conflicts before creating a pull request.
