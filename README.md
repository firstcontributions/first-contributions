...
Now clone the forked repository to your notAPilot machine. Go to your GitHub account, open the forked repository, click on the clone button and then click the *copy to clipboard* icon.
