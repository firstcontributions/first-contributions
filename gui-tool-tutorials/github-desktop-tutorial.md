...
# Github Desktop
<strong>GitHub Desktop</strong> is a graphical user interface (GUI) that allows you to interact with GitHub without using the command line or a web browser.
