...
| <img width="32" alt="PyCharm Icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/PyCharm_Icon.svg/32px-PyCharm_Icon.svg.png">| PyCharm |
| ------------------------------------------------------------------------------------------------------------------------------------ |---------|
...
If you don't have PyCharm on your machine, [install it](https://www.jetbrains.com/pycharm/download/?section=windows).

**Notice:** This tutorial was made using PyCharm (Version 2023.2.1) on a Windows 11 machine. Later in this tutorial we will make use of some keyboard shortcuts. These may differ on other operating systems (macOS/Linux).

## Fork this repository

<img align="right" width="300" src="https://upload.wikimedia.org/wikipedia/commons/8/81/Fork-for-github.png" alt="fork this repository" />
...
<img align="right" width="300" src="https://upload.wikimedia.org/wikipedia/commons/3/34/Clone.png" alt="clone your repository" />

The next step is to clone your repo down to your machine, so you can begin making changes. PyCharm needs the URL of your repo, so click the "clone" button and then click the "copy to clipboard" icon.
...
In PyCharm, all operations with branches are performed in the Git Branches popup. To invoke it, click the Git widget in the Status bar or press Ctrl+Shift+`.
